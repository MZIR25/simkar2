                ...
                @endif --}}
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="row">
                                <a href="/edit_jabatan/{{$j->jabatan_id}}"><i class="fas fa-edit bg-warning p-2 text-white rounded ml-2 mr-1" data-toggle="tooltip" title="Edit"></a></i>
                                <form class="d-inline " action="{{ url('delete_jabatan', $j->jabatan_id) }} " method="POST">
                                    {{ csrf_field() }}
                                    @method('DELETE')
     ...
     $("#myTable").DataTable({
        'dom': '<"container-fluid"<"row"<"col"Bl><"col"f>>><"bottom"<"container-fluid"t<"row"<"col"i><"col"p>r>>>',
            ...
            "buttons": [
                ...
                text: '<i class="fas fa-plus-square mr-2"></i>Upload Jabatan',
                className: 'btn btn-success mb-3',

                action: function ( e, dt, button, config ) {
                window.location = '/unggah_jabatan';
                }
            },
